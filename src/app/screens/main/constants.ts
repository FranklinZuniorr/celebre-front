...
export const optionsModel: ModelCardCelebrationProps[] = [
    { 
      ...
      celebrationData: {
        ...
        description: 'Que essa festa traga alegria, cores e muita energia positiva para você! Dance, sorria e aproveite cada momento com leveza e boas vibrações. 🎶🎉💃🕺',
    ...
    { 
        ...
        celebrationData: {
          ...
          description: 'Hoje é o seu dia! Que você tenha um ano maravilhoso, cheio de amor e momentos inesquecíveis! 🎂🎉🎁',
          email: 'aniversarioinfo@gmail.com',
          endPhrase: 'Feliz Aniversário! Que sua vida seja iluminada com saúde, amor e felicidade! 🎈🎉',
          imageLink: defaultAvatar,
    ...
    { 
      ...
      celebrationData: {
        ...
        description: 'Que o novo ano traga renovação, novas oportunidades e felicidade! Que todos os seus desejos se realizem neste novo ciclo. 🌟🎆',
    ...
    { 
      ...
      celebrationData: {
        ...
        endPhrase: 'Feliz Natal! Que a luz do Natal ilumine seu caminho e traga felicidade! 🌟🎁',
        imageLink: defaultAvatar,
        personName: 'Nome do homenageado',
